package cardexpansionpack.cards;
...
import cardexpansionpack.util.TriFunction;
...
import static cardexpansionpack.util.GeneralUtils.removePrefix;
import static cardexpansionpack.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return CardExpansionPack.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    CardExpansionPack.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
